        ...
        <div class="container">
            ...
            <div class="row row-my">
                ...
                <div class="col-lg-3">
                    ...
                    <h1 class="my-4 attention">Hottest auctions!</h1>
                ...
                <div class="col-lg-9">
                    ...
                    <div class="row">
                        ...
                        try {
                            ...
                            $sql = $db->query('SELECT *'
                                            . ' FROM listings WHERE expires_at > NOW() ORDER BY expires_at ASC')->fetchAll();
                            ...
                            $sql = $db->query('SELECT *'
                                            . ' FROM listings WHERE expires_at > NOW() ORDER BY expires_at ASC LIMIT ' . $func . ', 6')->fetchAll();
				    ...
				    <small class=\"card-footer\">Starting price: " . $starting_price . "$</small>
                                ...
                                if (isset($_SESSION['logged'])) {
                                    echo "<input type=\"text\" id=\"bid$id\" name=\"bid\" class=\"form-control\" placeholder=\"Place your bid:\">
                                <input type=\"submit\" class=\"btn btn-primary bid\" value=\"Place bid\">";
                                }
                                echo "</div>
                            </div>";
                            }
